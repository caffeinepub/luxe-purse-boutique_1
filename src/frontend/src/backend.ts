...
export class Backend implements backendInterface {
    ...
    async toggleProductStock(arg0: string): Promise<void> {
        if (this.processError) {
            try {
...
async function from_candid_opt_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Product]): Promise<Product | null> {
